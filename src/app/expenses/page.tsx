...
const Expenses = () => {
    ...
    /* *
     * hook de React que permite memorizar (o cachear) un valor calculado, evitando que se vuelva
     * calcular en cada renderización del componente, a menos que cambien ciertas dependencias. Esto
     * es útil para mejorar el rendimiento, especialmente si el cálculo es costoso.
     * */
    ...
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row justify-between gap-4">
                <div className="w-full md:1/3 bg-white shadow rounded-lg p-6">
